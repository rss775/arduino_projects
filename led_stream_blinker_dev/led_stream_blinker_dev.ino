...
#define M_PIN 13       // пин матрицы
#define M_WIDTH 28    // ширина матрицы
#define M_HEIGHT 1    // высота матрицы
...
void setup() {
  matrix.setBrightness(63);  // яркость (0-255)
  ...
  matrix.set(0, 1, mPurple);
  matrix.set(0, 2, mTeal);
  matrix.show();
  delay(3000);
  matrix.clear();
}
